...
local horses = {
    ...
    a_c_horse_morgan_palomino = { breed = 'Morgan', size = 'small', health = 2, stamina = 2, agility = 4, speed = 4, acceleration = 4, strength = 2 },
    ...
    a_c_horse_tennesseewalker_blackrabicano = { breed = 'Tennessee Walker', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 2 },
    a_c_horse_tennesseewalker_dapplebay = { breed = 'Tennessee Walker', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 2 },
    a_c_horse_tennesseewalker_mahoganybay = { breed = 'Tennessee Walker', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 2 },
    ...
    a_c_horse_shire_darkbay = { breed = 'Shire', size = 'large', health = 4, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 6 },
    a_c_horse_shire_ravenblack = { breed = 'Shire', size = 'large', health = 4, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 6 },
    ...
    a_c_horse_suffolkpunch_redchestnut = { breed = 'Suffolk Punch', size = 'large', health = 4, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 4 },
    ...
    a_c_horse_americanpaint_greyovero = { breed = 'American Paint', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    a_c_horse_americanpaint_overo = { breed = 'American Paint', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    ...
    a_c_horse_appaloosa_blacksnowflake = { breed = 'Appaloosa', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    a_c_horse_appaloosa_fewspotted_pc = { breed = 'Appaloosa', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    a_c_horse_appaloosa_leopard = { breed = 'Appaloosa', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    a_c_horse_appaloosa_leopardblanket = { breed = 'Appaloosa', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    ...
    a_c_horse_mustang_tigerstripedbay = { breed = 'Mustang', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    a_c_horse_mustang_blackovero = { breed = 'Mustang', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    a_c_horse_mustang_buckskin = { breed = 'Mustang', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    a_c_horse_mustang_chestnuttovero = { breed = 'Mustang', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    ...
    a_c_horse_nokota_reversedappleroan = { breed = 'Nokota', size = 'small', health = 2, stamina = 3, agility = 3, speed = 4, acceleration = 4, strength = 2 },
    ...
    a_c_horse_thoroughbred_bloodbay = { breed = 'Thoroughbred', size = 'medium', health = 2, stamina = 3, agility = 3, speed = 4, acceleration = 4, strength = 2 },
    a_c_horse_thoroughbred_brindle = { breed = 'Thoroughbred', size = 'medium', health = 2, stamina = 3, agility = 3, speed = 4, acceleration = 4, strength = 2 },
    a_c_horse_thoroughbred_reversedappleblack = { breed = 'Thoroughbred', size = 'medium', health = 2, stamina = 3, agility = 3, speed = 4, acceleration = 4, strength = 2 },
    ...
    a_c_horse_americanstandardbred_black = { breed = 'American Standardbred', size = 'medium', health = 2, stamina = 3, agility = 3, speed = 4, acceleration = 4, strength = 2 },
    a_c_horse_americanstandardbred_buckskin = { breed = 'American Standardbred', size = 'medium', health = 2, stamina = 3, agility = 3, speed = 4, acceleration = 4, strength = 2 },
    ...
    a_c_horse_norfolkroadster_black = { breed = 'Norfolk Roadster', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 4, acceleration = 4, strength = 2 },
    a_c_horse_norfolkroadster_dappledbuckskin = { breed = 'Norfolk Roadster', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 4, acceleration = 4, strength = 2 },
    a_c_horse_norfolkroadster_rosegrey = { breed = 'Norfolk Roadster', size = 'medium', health = 3, stamina = 3, agility = 3, speed = 4, acceleration = 4, strength = 2 },
    ...
    a_c_horse_criollo_baybrindle = { breed = 'Criollo', size = 'small', health = 3, stamina = 4, agility = 4, speed = 3, acceleration = 3, strength = 2 },
    a_c_horse_criollo_bayframeovero = { breed = 'Criollo', size = 'small', health = 3, stamina = 4, agility = 4, speed = 3, acceleration = 3, strength = 2 },
    a_c_horse_criollo_blueroanovero = { breed = 'Criollo', size = 'small', health = 3, stamina = 4, agility = 4, speed = 3, acceleration = 3, strength = 2 },
    a_c_horse_criollo_marblesabino = { breed = 'Criollo', size = 'small', health = 3, stamina = 4, agility = 4, speed = 3, acceleration = 3, strength = 2 },
    ...
    a_c_horse_breton_mealydapplebay = { breed = 'Breton', size = 'large', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 2, strength = 3 },
    a_c_horse_breton_sealbrown = { breed = 'Breton', size = 'large', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 2, strength = 3 },
    ...
    a_c_horse_gypsycob_palominoblagdon = { breed = 'Gypsy Cob', size = 'large', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 2, strength = 3 },
    a_c_horse_gypsycob_piebald = { breed = 'Gypsy Cob', size = 'large', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 2, strength = 3 },
    a_c_horse_gypsycob_splashedbay = { breed = 'Gypsy Cob', size = 'large', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 2, strength = 3 },
    ...
    a_c_horse_kladruber_grey = { breed = 'Kladruber', size = 'large', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 2, strength = 3 },
    a_c_horse_kladruber_silver = { breed = 'Kladruber', size = 'large', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 2, strength = 3 },
    ...
    a_c_horse_dutchwarmblood_sealbrown = { breed = 'Dutch Warmblood', size = 'large', health = 3, stamina = 3, agility = 3, speed = 3, acceleration = 3, strength = 3 },
    ...
    a_c_horse_hungarianhalfbred_darkdapplegrey = { breed = 'Hungarian Half-bred', size = 'large', health = 4, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 4 },
    a_c_horse_hungarianhalfbred_flaxenchestnut = { breed = 'Hungarian Half-bred', size = 'large', health = 4, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 4 },
    a_c_horse_hungarianhalfbred_piebaldtobiano = { breed = 'Hungarian Half-bred', size = 'large', health = 4, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 4 },
    a_c_horse_andalusian_rosegray = { breed = 'Andalusian', size = 'large', health = 5, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 4 },
    a_c_horse_andalusian_darkbay = { breed = 'Andalusian', size = 'large', health = 5, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 4 },
    a_c_horse_andalusian_perlino = { breed = 'Andalusian', size = 'large', health = 5, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 4 },
    a_c_horse_ardennes_irongreyroan = { breed = 'Ardennes', size = 'large', health = 5, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 4 },
    a_c_horse_ardennes_bayroan = { breed = 'Ardennes', size = 'large', health = 5, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 4 },
    a_c_horse_ardennes_strawberryroan = { breed = 'Ardennes', size = 'large', health = 5, stamina = 4, agility = 2, speed = 2, acceleration = 2, strength = 4 },
    a_c_horse_turkoman_darkbay = { breed = 'Turkoman', size = 'large', health = 4, stamina = 5, agility = 3, speed = 4, acceleration = 3, strength = 3 },
    a_c_horse_turkoman_black = { breed = 'Turkoman', size = 'large', health = 4, stamina = 5, agility = 3, speed = 4, acceleration = 3, strength = 3 },
    a_c_horse_turkoman_chestnut = { breed = 'Turkoman', size = 'large', health = 4, stamina = 5, agility = 3, speed = 4, acceleration = 3, strength = 3 },
    a_c_horse_turkoman_grey = { breed = 'Turkoman', size = 'large', health = 4, stamina = 5, agility = 3, speed = 4, acceleration = 3, strength = 3 },
    a_c_horse_turkoman_perlino = { breed = 'Turkoman', size = 'large', health = 4, stamina = 5, agility = 3, speed = 4, acceleration = 3, strength = 3 },
    ...
    a_c_horse_missourifoxtrotter_amberchampagne = { breed = 'Missouri Fox Trotter', size = 'medium', health = 3, stamina = 4, agility = 4, speed = 4, acceleration = 4, strength = 2 },
    a_c_horse_missourifoxtrotter_sablechampagne = { breed = 'Missouri Fox Trotter', size = 'medium', health = 3, stamina = 4, agility = 4, speed = 4, acceleration = 4, strength = 2 },
    a_c_horse_missourifoxtrotter_blacktovero = { breed = 'Missouri Fox Trotter', size = 'medium', health = 3, stamina = 4, agility = 4, speed = 4, acceleration = 4, strength = 2 },
    a_c_horse_missourifoxtrotter_blueroan = { breed = 'Missouri Fox Trotter', size = 'medium', health = 3, stamina = 4, agility = 4, speed = 4, acceleration = 4, strength = 2 },
    ...
    a_c_horse_arabian_black = { breed = 'Arabian', size = 'small', health = 3, stamina = 4, agility = 4, speed = 5, acceleration = 5, strength = 2 },
    a_c_horse_arabian_grey = { breed = 'Arabian', size = 'small', health = 3, stamina = 4, agility = 4, speed = 5, acceleration = 5, strength = 2 },
    a_c_horse_arabian_redchestnut = { breed = 'Arabian', size = 'small', health = 3, stamina = 4, agility = 4, speed = 5, acceleration = 5, strength = 2 },
    a_c_horse_arabian_redchestnut_pc = { breed = 'Arabian', size = 'small', health = 3, stamina = 4, agility = 4, speed = 5, acceleration = 5, strength = 2 },
    a_c_horse_arabian_rosegreybay = { breed = 'Arabian', size = 'small', health = 3, stamina = 4, agility = 4, speed = 5, acceleration = 5, strength = 2 },
    a_c_horse_arabian_warpedbrindle_pc = { breed = 'Arabian', size = 'small', health = 3, stamina = 4, agility = 4, speed = 5, acceleration = 5, strength = 2 },
}

local prices = {
    a_c_horse_mp_mangy_backup = 0,
    a_c_horse_dutchwarmblood_chocolateroan = 250,
    a_c_horse_dutchwarmblood_sealbrown = 250,
    ...
    a_c_horse_morgan_palomino = 55,
    a_c_horse_morgan_bayroan = 55,
    a_c_horse_mustang_reddunovero = 500,
    a_c_horse_suffolkpunch_sorrel = 120,
    a_c_horse_suffolkpunch_redchestnut = 120,
    a_c_horse_turkoman_darkbay = 925,
    a_c_horse_turkoman_black = 925,
    a_c_horse_turkoman_chestnut = 925,
    a_c_horse_turkoman_grey = 925,
    a_c_horse_turkoman_perlino = 925,
    a_c_horse_turkoman_gold = 950,
    a_c_horse_andalusian_rosegray = 440,
    a_c_horse_andalusian_darkbay = 440,
    a_c_horse_andalusian_perlino = 440,
    a_c_horse_breton_redroan = 150,
    a_c_horse_breton_mealydapplebay = 150,
    a_c_horse_breton_sealbrown = 150,
    a_c_horse_americanpaint_tobiano = 130,
    a_c_horse_americanpaint_greyovero = 130,
    a_c_horse_americanpaint_overo = 130,
    ...
    a_c_horse_norfolkroadster_black = 150,
    a_c_horse_norfolkroadster_dappledbuckskin = 150,
    a_c_horse_norfolkroadster_rosegrey = 150,
    a_c_horse_norfolkroadster_spottedtricolor = 950,
    a_c_horse_breton_steelgrey = 950,
    a_c_horse_kladruber_black = 150,
    a_c_horse_kladruber_grey = 150,
    a_c_horse_kladruber_silver = 150,
    a_c_horse_hungarianhalfbred_liverchestnut = 300,
    a_c_horse_hungarianhalfbred_darkdapplegrey = 300,
    a_c_horse_hungarianhalfbred_flaxenchestnut = 300,
    a_c_horse_hungarianhalfbred_piebaldtobiano = 300,
    ...
    a_c_horse_tennesseewalker_blackrabicano = 60,
    a_c_horse_tennesseewalker_dapplebay = 60,
    a_c_horse_tennesseewalker_mahoganybay = 60,
    ...
    a_c_horse_ardennes_bayroan = 450,
    a_c_horse_ardennes_strawberryroan = 450,
    a_c_horse_shire_lightgrey = 120,
    a_c_horse_shire_darkbay = 120,
    a_c_horse_shire_ravenblack = 120,
    a_c_horse_arabian_white = 1200,
    a_c_horse_arabian_black = 1200,
    a_c_horse_arabian_grey = 1200,
    a_c_horse_arabian_redchestnut = 1200,
    a_c_horse_arabian_redchestnut_pc = 1200,
    a_c_horse_arabian_rosegreybay = 1200,
    a_c_horse_arabian_warpedbrindle_pc = 1200,
    a_c_horse_belgian_blondchestnut = 120,
    a_c_horse_gypsycob_whiteblagdon = 150,
    a_c_horse_gypsycob_palominoblagdon = 150,
    a_c_horse_gypsycob_piebald = 150,
    a_c_horse_gypsycob_splashedbay = 150,
    ...
    a_c_horse_thoroughbred_bloodbay = 130,
    a_c_horse_thoroughbred_brindle = 130,
    a_c_horse_thoroughbred_reversedappleblack = 130,
    a_c_horse_mustang_grullodun = 130,
    a_c_horse_mustang_tigerstripedbay = 130,
    a_c_horse_mustang_blackovero = 130,
    a_c_horse_mustang_buckskin = 130,
    a_c_horse_mustang_chestnuttovero = 130,
    a_c_horse_nokota_whiteroan = 130,
    a_c_horse_nokota_blueroan = 130,
    a_c_horse_nokota_reversedappleroan = 130,
    ...
    a_c_horse_missourifoxtrotter_amberchampagne = 950,
    a_c_horse_missourifoxtrotter_sablechampagne = 950,
    a_c_horse_missourifoxtrotter_blacktovero = 950,
    a_c_horse_missourifoxtrotter_blueroan = 950,
    a_c_horse_appaloosa_blanket = 130,
    a_c_horse_appaloosa_blacksnowflake = 130,
    a_c_horse_appaloosa_fewspotted_pc = 130,
    a_c_horse_appaloosa_leopard = 130,
    a_c_horse_appaloosa_leopardblanket = 130,
    a_c_horse_appaloosa_brownleopard = 450,
    a_c_horse_americanstandardbred_palominodapple = 150,
    a_c_horse_americanstandardbred_black = 150,
    a_c_horse_americanstandardbred_buckskin = 150,
    ...
    a_c_horse_criollo_baybrindle = 150,
    a_c_horse_criollo_bayframeovero = 150,
    a_c_horse_criollo_blueroanovero = 150,
    a_c_horse_criollo_marblesabino = 150,
}
...
function HorseStats.Calculate(data)
    ...
    for _, stat in ipairs(HorseStats.StatNames) do
        ...
        finalStats[stat] = math.max(HorseStats.MinimumRank[stat], math.min(HorseStats.MaximumRank, startingStat + HorseStats.TrainingBonus[level][stat]))
        maximumStats[stat] = math.max(HorseStats.MinimumRank[stat], math.min(HorseStats.MaximumRank, startingStat + HorseStats.TrainingBonus[10][stat]))
    end

    return base, finalStats, level, maximumStats
end
